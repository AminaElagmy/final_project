...
<html lang="en">
  <head>
   ...
   <body>
    ...
    <form action="{{ route('data3',$product->id) }}"method="post" enctype="multipart/form-data">
        @csrf
        <input type ="hidden"name="product_id"value="{{$product->id}}">
        <div class="form-group">
            <label for="name">opertion</label>
            <input type="number"  name="opertion" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="name">medical</label>
            <input type="number"  name="medical" class="form-control" required>
        </div>
        <div class="form-group">
